...
class UnitPostProcess:
    def __init__(self,a1,b1,a2,b2,sx1,sy1,sx2,sy2,fx1,fy1,fx2,fy2,l,result,ax):
        self.a1=a1
        self.b1=b1
        self.a2=a2
        self.b2=b2
    ...
    def plot(self):    
        ...
        x=[self.a1,self.a2]
        y=[self.b1,self.b2]
        plt.scatter(x,y,c='w',marker='o', s=self.c8*self.l,edgecolors=self.pc,linewidths=self.c7*self.l, zorder=100)#s是点大小
        #画杆
