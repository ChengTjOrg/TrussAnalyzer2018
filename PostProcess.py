...
class postProcess:
    def __init__(self,l):
        self.l=l
    def loadtruss(self):
        (a1,b1,sx1,sy1,a2,b2,sx2,sy2,fn,dx1,dy1,dx2,dy2)=np.loadtxt('C:\\文件\\大二下\\绗架结构分析助手\\输出.txt',skiprows=0,delimiter=' ',dtype=float,usecols=(1,2,3,4,8,9,10,11,15,16,17,18,19),unpack=True)
        self.x1=list(a1+dx1)
        self.y1=list(b1+dy1)
        self.x2=list(a2+dx2)
        self.y2=list(b2+dy2)
